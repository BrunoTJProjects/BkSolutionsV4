...
public class DataAccess {
	...
	public synchronized int excluirChave(Cliente cliente, String hardware, String chave)
	...
	public synchronized JSONObject getChaves(Cliente cliente, String hardware)
	...
	public synchronized int setChaves(Cliente cliente, String hardware, JSONObject jsonObj)
			throws ClassNotFoundException, SQLException {
		PreparedStatement ps = null;
		Connection conexao = MysqlConnection.getConnection();
		int linhasafetadas = 0;
	...
	public synchronized String getChave(Cliente cliente, String hardware, String chave)
			throws SQLException, ClassNotFoundException {
		String valor = null;
		PreparedStatement ps = null;
		Connection conexao = MysqlConnection.getConnection();
	...
	public synchronized int setChave(Cliente cliente, String hardware, String chave, String valor)
			throws ClassNotFoundException, SQLException {
